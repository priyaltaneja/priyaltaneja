          ...
          <div className="space-y-8 text-lg text-black dark:text-white transition-colors duration-300">
            <div>
              <h2 className="text-2xl font-medium mb-4">
                hey, i'm <span className="decoration-pink-100 dark:decoration-pink-900 decoration-3 underline decoration-solid [text-decoration-skip-ink:none] transition-colors duration-300">priyal</span>!
              </h2>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>studying <span className="bg-pink-100 dark:bg-[#FF69B4]/60 px-1 rounded transition-colors duration-300 text-black dark:text-white">computer engineering</span> and working towards my iron ring @ <a href="https://www.eng.mcmaster.ca/" target="_blank" rel="noopener noreferrer" className="text-pink-500 dark:text-[#FF69B4] hover:text-pink-600 dark:hover:text-[#FF69B4]/80 transition-colors inline-flex items-center gap-1">mcmaster university <ExternalLink size={14} /></a></li>
                <li>exploring <span className="bg-pink-100 dark:bg-[#FF69B4]/60 px-1 rounded transition-colors duration-300 text-black dark:text-white">human-computer interaction</span> research @ the <a href="https://esilab.cas.mcmaster.ca/" target="_blank" rel="noopener noreferrer" className="text-pink-500 dark:text-[#FF69B4] hover:text-pink-600 dark:hover:text-[#FF69B4]/80 transition-colors inline-flex items-center gap-1">embodied social interaction (ESI) lab <ExternalLink size={14} /></a></li>
              </ul>
            </div>
