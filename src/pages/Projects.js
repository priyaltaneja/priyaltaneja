...
const PROJECTS = [
  {
    ...
    repo: 'https://github.com/priyaltaneja/multi-lora-serving-benchmark',
    links: [
      {
...
const Projects = ({ onNavigate }) => {
  ...
  return (
    <main id="main-content" className="archive-page archive-page--projects min-h-dvh w-full transition-colors duration-200">
