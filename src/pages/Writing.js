...
const Writing = ({ onNavigate }) => {
  ...
  return (
    <main id="main-content" className="archive-page archive-page--writing min-h-dvh w-full transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 pt-28 md:pt-32 pb-16 sm:px-6 lg:px-8">

        <div className={`transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
          <h1 className="text-3xl sm:text-5xl font-serif italic tracking-tight leading-tight mb-12 text-center text-black dark:text-white drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)] transition-colors duration-200">Notes</h1>
