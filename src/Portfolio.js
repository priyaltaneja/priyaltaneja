      ...
      <section className="index-identity" aria-labelledby="home-title">
        <div className="index-identity__copy">
          ...
          <p className="index-tagline reveal-item">
            I study Computer Engineering at <a href="https://www.eng.mcmaster.ca/" target="_blank" rel="noreferrer">McMaster</a> and build agents for freight and logistics as a MTS at <a href="https://e3group.ai/" target="_blank" rel="noreferrer">e3</a>. I’m curious about ML systems, how complex ideas become useful products, and learning how to think well before reaching for the right answer.
          </p>
